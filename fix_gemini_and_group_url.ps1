...
# 2. Replace adapters.py with both adapters (single-quoted here-string)
...
# 3. Update services.py to use Gemini
...
# 4. Add group-info URL to chat_project/urls.py (single-quoted here-string)
...
# 5. Ensure group_info.html exists (with a plain "Back" link, no arrow)
...
Write-Host "`nFixes applied successfully. Test group info page and smart replies." -ForegroundColor Green